<?php
	 class Employee_Model extends CI_Model {
	 	...
	 	var $column_order = array('name', 'user_id', 'username');
	    var $search_column = array('name', 'user_id', 'username', 'acroname', 'business_unit'); //set column field database for datatable searchable 
