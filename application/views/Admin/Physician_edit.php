            ...
            <div class="col-md-10">
              <!-- general form elements -->
                ...
                <div class="box box-success">
                    ...
                    <form role="form" action="<?php echo base_url() ?>Admin/PhysicianUpdate" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                              <input type="hidden" name="old_physician_id" value="<?php echo $old_physician_id;?>">
                        ...
                        <div class="box-footer">
                            <button data-toggle="modal" data-target="#spinner_modal"  onclick="return Validate()" style="color: white" type="submit" class="btn btn-primary"  value="Submit" /><i class = "fa fa-save"></i> Submit</button> 
                            
                            <a class="btn btn-danger"  href="<?=base_url('view-physician-a')?>"><i class="fa fa-close"></i> Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
