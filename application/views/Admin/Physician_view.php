...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1><i class="fa fa-user-md" aria-hidden="true"></i>
        Manage Physician Accounts
      ...
      <!-- <div class="row">
            <div class="col-xs-12 text-left">
                <div class="form-group">
                    <a class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus" aria-hidden="true"></i> Add Physician</a>
                </div>
            </div>
        </div> -->
        <div class="row">
            <div class="col-xs-12">
              <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title">Physician Record List</h3>
              </div>

              <div class="card" style="padding-right: 400px; padding-left: 400px;">
           ...
           <div class="box-body table-responsive">
              ...
              <tbody>
                <?php
                if(!empty($getPhysician))
                {
                    foreach ($getPhysician as $value)
                        { ?>
                          <tr>
                            <!-- <td style="display: none;"><?=$value->physician_id?></td> -->
                            ...
                            <td>  
                                ...
                                <a class="btn btn-warning swalDefaultSuccess" style="color: #ffff" onclick="return confirmDialogEdit();" href = "<?php echo base_url() . "/physician-a-edit/" . $value->physician_id; ?>"><i class="fa fa-edit"></i> Update Password </a> 
                        <!-- <form class="form-inline" method="post" action = "Admin/UpdateStatusPhy">
                            <input type="hidden" name="physician_id" value="<?php echo $value->physician_id;?>">
