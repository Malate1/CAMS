...
<div
  ...
  data-modal-title="Reset Patient Password"
  data-modal-eyebrow="Account recovery"
  data-modal-description="Generate a secure temporary password for this patient account."
  data-modal-width="620px"
>
  <form
    action="<?=base_url('Admin/PatientUpdate')?>"
    method="post"
    class="space-y-5"
    data-cams-ajax="true"
    data-keep-open-on-success="true"
    data-confirm-title="Reset this patient's password?"
  ...
  >
    <input type="hidden" name="old_patient_id" value="<?=htmlspecialchars((string)$old_patient_id, ENT_QUOTES, 'UTF-8')?>">
    ...
    <div class="rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
      <div class="flex gap-3">
        ...
        <div>
          ...
          <span class="mt-1 block leading-6">This password is generated by CAMS and will replace the patient's current password after you confirm the reset. Ask the patient to change it after signing in.</span>
        </div>
      </div>
    </div>
    ...
    <div class="hidden rounded-2xl border border-emerald-200 bg-emerald-50 p-4" data-cams-reset-result>
      ...
      <p class="mb-0 mt-1 text-sm text-emerald-700">Copy the password above and provide it securely to the patient.</p>
    </div>
