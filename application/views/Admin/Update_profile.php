              ...
              <!-- general form elements -->
                ...
                <div class="box box-success">
                   ...
                   <ul class="nav nav-tabs" role="tablist">
                     ...
                     <!-- <form role="form" action="<?php echo base_url() ?>Admin/ProfileUpdate" method="post" role="form">  -->

                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="home">

                            <form action="<?php echo base_url('Admin/ProfileUpdate') ?>" method="post" id="editPatient" enctype="multipart/form-data">   
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">                                  
                                    <div class="form-group">
                                        ...
                                        <input  type="text" class="form-control" id="address"  value="<?php echo $records[0]->address;?>" name ="address"  >    
                                    </div>
                                </div>

                                <!-- <div class="col-md-6"> 
                                    <img src="<?php echo base_url(); ?>uploads/profile-pic/<?=$this->session->image ?>" class="img-thumbnail rounded mb-2" alt="User Image" style="height: 100px; width: 100px;">                                 
                                    <div class="form-group">
                                        <label for="image">Image</label>
                                        <input type="file" class="form-control" id="Editphoto" name ="Editphoto" value="<?php echo $records[0]->image;?>" >    
                                    </div>
                                </div> -->
                            </div>
                        </div><!-- /.box-body -->
