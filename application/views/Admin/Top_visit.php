          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content" style="border-radius: 10px">
              <div class="modal-header">
                ...
                <h4 style="text-align: center;" class="modal-title"><b>Enter Date Range for Top Visited Clinics</b></h4> 
            </div>
            <div class="modal-body">
                <form role="form" action="<?php echo base_url() ?>Admin/ViewTopVisited" method="post" role="form">
                    <div class="box-body">
                        <div class="row">
    ...
    <div class="col-xs-12">
      <div class="box box-success">
        <div class="box-header">
          <h3 class="box-title">Top Visited Clinic</h3>
      </div>
      ...
      <tbody>
        <?php
        if(!empty($getTopVisited))
        {
            foreach ($getTopVisited as $value)
                { ?>
                  <tr>
