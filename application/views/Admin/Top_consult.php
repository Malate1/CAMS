            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content" style="border-radius: 10px">
                <div class="modal-header">
                  ...
                  <h4 style="text-align: center;" class="modal-title"><b>Enter Date Range for Top Consulted Ailments</b></h4>
                </div>
                <div class="modal-body">
                  <form role="form" action="<?php echo base_url() ?>Admin/ViewTopConsulted" method="post" role="form">
                    <div class="box-body">
                      <div class="row">

                        <div class="col-lg-6 input_field_sections">
                          <h5>Start Date <span style="color: #cc0000">*</span></h5>
                          <input required="" type="date" class="form-control"  name="first" value=""/>
                        </div>

                        <div class="col-lg-6 input_field_sections">
                          <h5>End Date <span style="color: #cc0000">*</span></h5>
                          <input required="" type="date" class="form-control"  name="last" value=""/>
                        </div>                               
                      </div>
            ...
            <div class="row">
              <div class="col-xs-12 text-left">
                <div class="form-group">
                  <a class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus" aria-hidden="true"></i> Date Range</a>
                </div>
              </div>
            </div>
              ...
              <div class="col-xs-12">
                <div class="box box-success">
                  <div class="box-header">
                    <h3 class="box-title">Top Consulted Ailments</h3>
                  </div>
                  ...
                  <tbody>
                    <?php
                    if(!empty($getTopConsulted))
                    {
                      foreach ($getTopConsulted as $value)
                        { ?>
                          <tr>
