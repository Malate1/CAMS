  ...
  <div class="modal-dialog" role="document" >
    ...
    <div class="modal-content" style="border-radius: 10px">
      <div class="modal-header">
        ...
        <h4 style="text-align: center;" class="modal-title"><b>Sign up Form for Secretary</b></h4> 
    </div>
    <div class="modal-body">
        <!-- <?php echo form_open('SignUp/secretary'); ?> -->

        <form action="<?php echo base_url('SignUp/secretary') ?>" method="post" id="addSec" enctype="multipart/form-data"> 
...
<div class="col-lg-6 input_field_sections">
  ...
  <input required type="password" id="cpassword" class="form-control" name="cpassword" value=""/>
</div>
...
<div class="modal-footer" style="border-radius: 10px">
  ...
  <?php
  $authRole = 'Secretary';
  $authHeadline = 'Keep every clinic day on track.';
  $authDescription = 'Coordinate patient bookings, physician schedules and daily clinic operations from one workspace.';
  $authBadge = 'Secretary portal';
  ...
  <div class="login-box-body" style="border-radius: 5px">
      <p class="login-box-msg">Secretary Login</p>
...
<form action="<?php echo base_url(); ?>Login/logSec" method="post">
