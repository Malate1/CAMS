...
<div id="myModal" class="modal fade cams-edit-modal cams-uniform-modal" role="dialog" aria-labelledby="add-schedule-title">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="<?=base_url('Secretary/ScheduleRegister')?>" method="post" data-cams-ajax="true" data-confirm-title="Add this clinic schedule?" data-confirm-text="Please confirm the clinic, duty days, and time before saving." data-confirm-button="Yes, add schedule">
            ...
            <div class="box box-success">
              <div class="box-header">
                ...
                <div class="box-body table-responsive">
                    <table class="table cams-modern-table" id="cams-management-table" width="100%" data-cams-server="true" data-kind="schedule" data-source="<?=base_url('table-data/secretary-schedules')?>" data-edit-base="<?=base_url('schedule-s-edit')?>" data-flash-success="<?=htmlspecialchars((string)$camsSuccess, ENT_QUOTES, 'UTF-8')?>" data-flash-error="<?=htmlspecialchars((string)$camsError, ENT_QUOTES, 'UTF-8')?>">
                      <thead>
                        <tr role="row">
                          <th >Schedule ID</th>
                          <th >Clinic</th>
                      ...
                      foreach ($getSchedule as $value)
                        { ?>
                          <tr>
                            ...
                            <td>   
                              <a class="btn btn-warning swalDefaultSuccess"  onclick="return confirmDialogEdit();" href = "<?php echo base_url() . "/schedule-s-edit/" . $value->schedule_id; ?>">Edit <i class="fa fa-edit"></i></a>
                          </td>
                      </tr>   
                  <?php }
              }
