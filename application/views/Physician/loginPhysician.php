...
<div id="myModal" class="modal fade" tabindex="-1"  aria-labelledby="myModalLabel" role="dialog">
	<div class="modal-dialog" role="document" >
		...
		<div class="modal-content" style="border-radius: 10px">
			<div class="modal-header">
				...
				<h4 style="text-align: center;" class="modal-title"><b>Sign up Form for Physician</b></h4> 
			</div>
			<div class="modal-body">
				<!-- <?php echo form_open('SignUp/physician'); ?> -->

				<form action="<?php echo base_url('SignUp/physician') ?>" method="post" id="addPhy" enctype="multipart/form-data"> 
					...
					<div class="row">  
						...
						<div class="col-lg-6 input_field_sections">
							...
							<input required="" type="text" class="form-control" name="contact" value=""/>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-6 input_field_sections">
							<h5>Specialization <span style="color: #cc0000">*</span></h5>
							<select class="form-control" required="" name = "special_name">
								...
								<option value="Onconlogist ">Onconlogist </option>
					...
					<hr>
					<h5 style="text-align: center;"><b>Schedule Details</b></h5>
					<div class="row">

						<div class="col-lg-6 input_field_sections">
							<h5>Days of Duty<span style="color: #cc0000">*</span></h5>
							<select required="" class="form-control" required="" name = "day">
								<option value="MTW">MTW</option>
								<option value="TTh">TTh</option>
								<option value="Sat">Saturday</option>
								<option value="Sun">Sunday</option>
								<option value="MTW">MWF</option>
							...
							<div class="bootstrap-timepicker">
								<div class="form-group">                                                  
									<div class="input-group">
										<input required="" type="time" class="form-control timepicker" name="time_in">
						...
						<div class="col-lg-6 input_field_sections">
							...
							<div class="bootstrap-timepicker">
								<div class="form-group">                                                  
									<div class="input-group">
										<input required type="time" class="form-control timepicker" name="time_out">
										<div class="input-group-addon">
											<i class="fa fa-clock-o"></i>
										</div>
									</div>                                                
					...
					<div class="row">
						...
						<div class="col-lg-6 input_field_sections">
							...
							<input required id="cpassword" type="password" class="form-control" name="cpassword" value=""/>
						</div>
	...
	<?php
	$authRole = 'Physician';
	$authHeadline = 'Focus on patients, not appointment friction.';
	$authDescription = 'Review your clinic schedule, manage daily appointments and keep patient visits organized.';
	$authBadge = 'Physician portal';
	...
	<div class="login-box">
		...
		<div class="login-box-body" style="border-radius: 5px">
			<p class="login-box-msg">Physician Login</p>
			...
			<form action="<?php echo base_url(); ?>Login/logDoctor" method="post">
