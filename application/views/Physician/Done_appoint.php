        ...
        <div class="modal-content" style="border-radius: 10px">
                      <div class="modal-header">
                        ...
                        <center><img src="<?=base_url()?>assets/dist/img/hnumcfi.jpg" class="img-circle"  alt="logo" style="height: 40px; width: 40px;"></center> 
                         <h4 style="text-align: center;" class="modal-title"><b> Choose Month for Done Appointments</b></h4> 
                      </div>
                      <div class="modal-body">
                        <form role="form" action="<?php echo base_url() ?>Physician/ViewDone" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Done Appointments </h3>
            </div>
