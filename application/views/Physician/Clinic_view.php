                ...
                foreach ($getClinic as $value)
                    { ?>
                      <tr>
                        ...
                        <td>
                            <a class="btn btn-warning swalDefaultSuccess" style="color: #ffff" onclick="return confirmDialogEdit();" href = "<?php echo base_url() . "/clinic-p-edit/" . $value->clinic_id; ?>"><i class="fa fa-edit"></i> Edit </a>

                            
                            <!-- <a class="btn btn-danger" onclick="return confirmDialog();" href = "<?php echo base_url("Physician/ClinicDelete/$value->clinic_id"); ?>">Delete <i class="fa fa-trash"></a> --></td>
                            </tr>   
                        <?php   }
                    }
                    ?>
