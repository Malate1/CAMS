...
<section class="content">
    ...
    <div class="row">
      ...
      <div class="box box-success">
        ...
        <form role="form" action="<?php echo base_url() ?>Physician/Change_pass" method="post" role="form">
            <div class="box-body">
                <div class="row">
                <div class="col-md-6">   
        ...
        <div class="box-footer">
                           <!--  <input onclick="return Validate()"  type="submit" class="btn btn-primary" value="Submit" />
