                ...
                <div class="box box-success">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <form action="<?php echo base_url('Physician/ProfileUpdate') ?>" method="post" id="editPatient" enctype="multipart/form-data">    
                        <div class="box-body">
                            <div class="row">
                        ...
                        <div role="tabpanel" class="tab-pane" id="profile"> <!-- for photo -->
                            <form action="<?php echo base_url('Physician/ProfilePicUpdate') ?>" role="form" method="post" id="editPatient" enctype="multipart/form-data">     
                        <div class="box-body">
